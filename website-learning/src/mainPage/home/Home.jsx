...
const MidCompsArray = [
  {
    ...
    RightSideHeading: (
      <h2 className="font-mail">ส่งเสริมพัฒนาการด้านร่างกาย ของเด็กอนุบาล</h2>
    ),
    RightSideText: (
      <h5>
    ...
    RightCommenter: (
      <h2 className="font-mail">การใช้กล้ามเนื้อเล็ก การใช้กล้ามเนื้อใหญ่</h2>
    ),
  ...
  },
  {
    ...
    RightSideHeading: (
      <h2 className="font-mail">ส่งเสริมพัฒนาการด้านอารมณ์ จิตใจ</h2>
    ),
    RightSideText:
      <h5>ให้เด็กได้แสดงออกทางอารมณ์และความรู้สึกของตนเองที่เหมาะสมกับวัย ตระหนักถึงลักษณะพิเศษเฉพาะที่เป็นอัตลักษณ์ ความเป็นตัวของตัวเอง มีความสุข ร่าเริงแจ่มใส การเห็นอกเห็นใจผู้อื่นได้พัฒนาคุณธรรม จริยธรรม สุนทรียภาพ ความรู้สึกที่ดีต่อตนเอง และความเชื่อมั่นในตนเองขณะปฏิบัติกิจกรรม</h5>,
    RightSideComment:
      <h5>สุนทรียภาพ ดนตรี การเล่น คุณธรรม จริยธรรม การแสดงออกทางอารมณ์ การมีอัตลักษณ์เฉพาะตนและเชื่อว่าตนเองมีความสามารถ การเห็นอกเห็นใจผู้อื่น</h5>,
    // logo2: "logo_school.jpg",
  },
  {
    id: 3,
    ...
    RightSideHeading: <h2 className="font-mail">ส่งเสริมพัฒนาการด้านสังคม</h2>,
    RightSideText: (
      <h5>
            ...
            <VStack p="10" textAlign="center">
              ...
              >
                <h5>
                  ...
                  เพื่อสร้างรากฐานคุณภาพชีวิตให้เด็กพัฒนาไปสู่ความเป็นมนุษย์ที่สมบูรณ์เกิดคุณค่าต่อตนเอง
