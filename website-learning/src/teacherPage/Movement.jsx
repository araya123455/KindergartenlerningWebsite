...
const Movement = () => {
  ...
  // Specify the ID for which you want to fetch the video link
  const specifiedId = "contV_id = 1"; // Replace with the actual ID

  // Find the data with the specified ID
  const specifiedData = showdata.find((data) => data.contV_id === specifiedId);
              ...
              >
                <img
                  src={`https://img.youtube.com/vi/${getVideoIdFromLink(
                    video_link
                  )}/0.jpg`} // Use getVideoIdFromLink to extract the video ID
                  alt="Video Thumbnail"
